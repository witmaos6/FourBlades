...
#include "FBGameplayTags.h"
#include "GameplayTagsManager.h"

FFBGameplayTags FFBGameplayTags::GameplayTags;

void FFBGameplayTags::InitializeNativeTags()
{
	UGameplayTagsManager& Manager = UGameplayTagsManager::Get();
	GameplayTags.AddAllTags(Manager);
}

void FFBGameplayTags::AddTag(FGameplayTag& OutTag, const ANSICHAR* TagName, const ANSICHAR* TagComment)
{
	OutTag = UGameplayTagsManager::Get().AddNativeGameplayTag(FName(TagName), FString(TEXT("(Native) ")) + FString(TagComment));
}

void FFBGameplayTags::AddAllTags(UGameplayTagsManager& Manager)
{
	...
	AddTag(InputTag_Ability_Confirm, "InputTag.Ability.Confirm", "");
}
