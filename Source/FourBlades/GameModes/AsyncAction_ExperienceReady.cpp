...
void UAsyncAction_ExperienceReady::Step2_ListenToExperienceLoading(AGameStateBase* GameState)
{
	...
	{
		ExperienceManagerComponent->CallOrRegister_OnExperienceLoaded(FOnFBExperienceLoaded::FDelegate::CreateUObject(this, &ThisClass::Step3_HandleExperienceLoaded));
	}
}

void UAsyncAction_ExperienceReady::Step3_HandleExperienceLoaded(const UFBExperienceDefinition* CurrentExperience)
{
